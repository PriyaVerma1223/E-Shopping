                    ...
                    <div className="mb-3">
                        ...
                        onChange={(e) => {
                          setProduct({
                            ...
                            name="description" placeholder="Product Description" rows="5" className=" w-full px-2 py-1 text-indigo-300 bg-indigo-50 border border-indigo-200 rounded-md outline-none placeholder-indigo-300 ">
                        </textarea>
                    </div>
